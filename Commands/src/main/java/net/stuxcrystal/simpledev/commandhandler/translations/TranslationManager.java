...
import net.stuxcrystal.simpledev.commandhandler.translations.contrib.EnumResolver;
import net.stuxcrystal.simpledev.commandhandler.translations.contrib.PrefixingResolver;
import net.stuxcrystal.simpledev.commandhandler.translations.contrib.SimpleVariableReplacer;
import net.stuxcrystal.simpledev.commandhandler.utils.MessageColor;
