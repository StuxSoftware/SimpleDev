package net.stuxcrystal.simpledev.commandhandler.contrib.history;
...
public class HistoryComponent implements ComponentContainer {
     ...
     * when {@link #redoAction(net.stuxcrystal.simpledev.commandhandler.CommandExecutor)} is being executed.
     *
