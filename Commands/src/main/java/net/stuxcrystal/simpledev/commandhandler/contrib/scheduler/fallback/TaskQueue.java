package net.stuxcrystal.simpledev.commandhandler.contrib.scheduler.fallback;
 ...
 *
 * <p>
 *     Please note that the task queue actually depends on the Root-{@link net.stuxcrystal.simpledev.commandhandler.CommandHandler}
