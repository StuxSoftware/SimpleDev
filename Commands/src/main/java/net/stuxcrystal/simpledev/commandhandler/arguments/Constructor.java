package net.stuxcrystal.simpledev.commandhandler.arguments;

import net.stuxcrystal.simpledev.commandhandler.arguments.types.CommandExecutorType;
import net.stuxcrystal.simpledev.commandhandler.arguments.types.EnumType;
import net.stuxcrystal.simpledev.commandhandler.arguments.types.PrimitiveType;
import net.stuxcrystal.simpledev.commandhandler.arguments.types.StringType;
