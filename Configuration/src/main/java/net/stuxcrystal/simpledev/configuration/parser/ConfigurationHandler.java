...
import net.stuxcrystal.simpledev.configuration.logging.ErrorStreamBinding;
import net.stuxcrystal.simpledev.configuration.parser.node.Node;
import net.stuxcrystal.simpledev.configuration.storage.contrib.filebased.FileBasedStorageBackend;
...
public class ConfigurationHandler {
     ...
     * @throws net.stuxcrystal.simpledev.configuration.parser.exceptions.ConfigurationException
     *          If something fails.
     */
